...
export default function App() {
  ...
  const transport = useMemo(() => {
    ...
    switch (form.transport) {
      case "자동차":
        return Number(cost.carToll || 0) + Number(cost.carParking || 0);
...
function Input({ label, value, onChange, type, disabled }) {
  return (
